         ...
         std::string &v)
{
  ...
  for(int i=0; i<nodes.size();i++){
    ...
    if (h.safebind()) {
          ret = h.safebind()->call(paxos_protocol::preparereq,src,a,r,rpcc::to(1000));
    }
    if (!h.safebind()) {
          continue;
    }
        ...
        std::vector<std::string> nodes, std::string v)
{
  ...
  for(int i=0;i<nodes.size();i++){
    ...
    if (h.safebind()) {
          ret = h.safebind()->call(paxos_protocol::acceptreq,src,a,r,rpcc::to(1000));
    }
    if (!h.safebind()) {
          continue;
    }
	      ...
	      std::string v)
{
  ...
  for(int i=0;i<accepts.size();i++){
    ...
    if (h.safebind()) {
          ret = h.safebind()->call(paxos_protocol::decidereq,src,a,r,rpcc::to(1000));
    }
